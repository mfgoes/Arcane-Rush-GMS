...
draw_set_alpha(1);
//draw_text_transformed(10,30,"z_axis " + string(z_axis),1,1,0);
draw_set_color(c_black);

draw_text_transformed(10,60,"dcos z " + string(dcos(global.z)),1,1,0);
draw_text_transformed(200,60,"dsin z " + string(dsin(global.z)),1,1,0);
var _str = "Use right mouse button to Rotate\nSpace to focus\nWheel to change FOV";

draw_text(10, 120, _str);
